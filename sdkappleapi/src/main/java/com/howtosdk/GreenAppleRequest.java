...
public class GreenAppleRequest implements Requestable {
  private final String requiredFoo;
  private final String optionalBar;

  public GreenAppleRequest(@NonNull String requiredFoo, @Nullable String optionalBar) {
